        ...
        return (
            <Layout className="layout">
                <Header className="header">
                    ...
                    <div className="menu">
                        <Menu theme="light" mode="horizontal" style={{ lineHeight: "64px" }} defaultSelectedKeys={[this.props.location.pathname]}>
                    ...
                    <div className="name">
                        ...
                        <Button type="primary" shape="circle" className="button" onClick={this.logout}>
                            登出
            </Button>
                    </div>
                </Header>
